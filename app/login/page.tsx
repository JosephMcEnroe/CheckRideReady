      ...
      <div className="hidden lg:flex lg:flex-1 bg-primary px-12 py-10 flex-col justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="text-white/80 text-sm mb-8">
            AI-powered oral exam preparation for serious student pilots and Part 141 flight schools.
          </p>
          ...
          <div className="mt-8 pt-6 border-t border-white/10">
            <p className="text-white/60 text-[13px]">Used by flight schools across the country</p>
          </div>
        </div>
     </div>
          ...
          <div className="bg-card rounded-xl border border-border px-7 py-6 shadow-lg">
            {infoMessage ? (
              <div className="text-center space-y-4 py-4">
                <div className="h-16 w-16 rounded-full bg-[#22c55e]/10 flex items-center justify-center mx-auto">
                  <Mail className="h-8 w-8 text-[#22c55e]" />
                </div>
                <div>
                  <h3 className="font-semibold text-foreground text-lg">Check your email</h3>
                  <p className="text-sm text-muted-foreground mt-1">We sent a sign-in link to</p>
